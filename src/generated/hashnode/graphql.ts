...
export type RedirectedPostQueryVariables = Exact<{
  host: Scalars['String']['input'];
  postSlug: Scalars['String']['input'];
}>;

export type RedirectedPostQuery = {
  __typename?: 'Query';
  publication?: {
    __typename?: 'Publication';
    id: string;
    redirectedPost?: { __typename?: 'Post'; id: string; slug: string } | null;
  } | null;
};
...
export const PostWithMarkdownContentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'PostWithMarkdownContent' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'Post' },
      },
...
} as unknown as DocumentNode<DraftQuery, DraftQueryVariables>;
...
export const PostSlugsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'PostSlugs' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'host' } },
...
export const RedirectedPostDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'RedirectedPost' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'host' } },
...
} as unknown as DocumentNode<RedirectedPostQuery, RedirectedPostQueryVariables>;
