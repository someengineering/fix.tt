...
const Compare = ({ blok }) => (
    <div className="compare">
      <div
        className="mb-12 flex items-center space-x-10 compare__pictures"
        aria-hidden="true"
        {...storyblokEditable(blok)}
      >
        <StoryblokImage blok={blok} picture={blok.picture_1} className="h-24 w-24 text-cornflower-blue-600" />
        <span className="h-10 w-10 rounded-full bg-marian-blue-50 text-lg font-extrabold leading-10 text-center">
          VS
        </span>
