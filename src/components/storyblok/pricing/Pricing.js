...
const Pricing = ({ blok }) => {
  ...
  return (
    <>
        <div className="mx-auto mt-20 grid max-w-md grid-cols-1 items-stretch gap-8 text-left md:max-w-3xl md:grid-cols-2" {...storyblokEditable(blok)}>
