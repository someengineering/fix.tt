    ...
    <span className="isolate inline-flex flex-nowrap -space-x-px rounded-md">
      ...
      <LinkedinShareButton url={url} title={title}>
        <span
          ...
          aria-hidden="true"
          className="relative inline-flex items-center bg-white px-3.5 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 hover:text-[#007fb1] focus:z-10"
        >
